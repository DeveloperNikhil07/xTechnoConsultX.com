            ...
            <section className="skills-counter-wrapper py mt section-bg-mode">
                <div className="container">
                    <div className="row section-title">
                        <div className="col-12 mt-sm-3 mt-md-0 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <div className="col-12 mt-3 mt-sm-3 mt-md-0 col-sm-6 col-md-4 col-lg-3">
                            <div className="card border py-5 text-center">
                        ...
                        <div className="col-12 mt-3 mt-sm-3 mt-lg-0 col-sm-6 col-md-4 col-lg-3">
                            <div className="card border py-5 text-center">
