                    ...
                    <div className='row'>
                        <div className='slider-wrapper'>
                            <Slider {...SliderSetting}>
                                <div data-aos={"slide-up"} data-aos-delay="100" className='slider-card border rounded gap-3 d-flex align-item-center mt-5 align-items-center'>
                                    ...
                                    <div className='col-12 mt-4 mt-md-0 col-md-6'>
                                        <div className='card-content section-title'>
                                ...
                                {/* Row 2 */}
                                <div className='slider-card border rounded gap-3 d-flex align-item-center mt-5 align-items-center'>
                                    <div className='col-12 col-md-6'>
                                        <div className='whoweare-image rounded'>
                                            <Image src={`${GetImages}/assets/images/banner-image.jpg`} alt='Portfolio Image' priority height={500} width={600} />
                                        </div>
